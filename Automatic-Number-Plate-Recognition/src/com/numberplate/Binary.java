...
public void run(String[] args) {
        ...
        // Load the image
        Mat src = Highgui.imread("C:\\Users\\Balaji\\eclipse-workspace\\Automatic-Number-Plate-Recognition\\testdata\\test5.jpg", Highgui.CV_LOAD_IMAGE_GRAYSCALE);
        ...
        //save image 
		Highgui.imwrite("C:\\Users\\Balaji\\eclipse-workspace\\Automatic-Number-Plate-Recognition\\testdata\\test5.jpg", bw);
		...
		//save image
		Highgui.imwrite("C:\\Users\\Balaji\\eclipse-workspace\\Automatic-Number-Plate-Recognition\\testdata\\test5.jpg", drawcontour);
	        
		//Finding top contours
		List<MatOfPoint> newcont = new ArrayList<MatOfPoint>();
		Mat ori = Highgui.imread(NumberPlateTest.getName());
		Mat newori = ori;
		double maxArea = 0;
		...
		//save image
		Highgui.imwrite("C:\\Users\\Balaji\\eclipse-workspace\\Automatic-Number-Plate-Recognition\\testdata\\test5.jpg", newori);
		
	    //Finding number plate area
	    List<MatOfPoint> rectangle = new ArrayList<MatOfPoint>();
	    Mat img2 = Highgui.imread(NumberPlateTest.getName());
	    Mat topcontour = img2;
		...
		//save image
		Highgui.imwrite("C:\\Users\\Balaji\\eclipse-workspace\\Automatic-Number-Plate-Recognition\\testdata\\test5.jpg", topcontour);
		...
		if(ROI.empty()) {
			...
			Highgui.imwrite("C:\\Users\\Balaji\\eclipse-workspace\\Automatic-Number-Plate-Recognition\\testdata\\test5.jpg", topcont);
			Highgui.imwrite("C:\\Users\\Balaji\\eclipse-workspace\\Automatic-Number-Plate-Recognition\\testdata\\test5.jpg", ROI);
		}
    }
}
