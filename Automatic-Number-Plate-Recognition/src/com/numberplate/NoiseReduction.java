    ...
    int[] green = new int[9];
	   ...
	   public NoiseReduction() {
	      try {
	         ...
	         File input = new File("C:\\Users\\Balaji\\eclipse-workspace\\Automatic-Number-Plate-Recognition\\testdata\\test5.jpg");
	         ...
	         //save image
	         File output = new File(NumberPlateTest.outputFile+"//NoiseReduction.jpg");
